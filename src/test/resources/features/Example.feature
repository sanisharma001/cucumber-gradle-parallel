@SmokeTests @twoFeatureFile
Feature: Kehe Connect UAT Automation new Feature
  ...
  @customerListNavigation @automation @prodSafe @customerManagement @CESmokeStable @parallelTest @firstScenario @myTest
  ...
  @customerListNavigation @automation @prodSafe @customerManagement @CESmokeStable @parallelTest  @secondScenario
  Scenario: Verify Customer list
    Then  I verify user is on "Manage Customers" page
