...
public class Config {
  ...
  public static String USERNAME = getProperty("username", "auto.it.kehe@gmail.com");
  public static String PASSWORD = getProperty("password", "password");
  public static String PROD_USER = getProperty("user", "user1Prod");
  private static String env = getProperty("env", "https://uatconnectenterprise.kehe.com");
  Boolean parallel = Boolean.parseBoolean(getProperty("parallel", "true"));
